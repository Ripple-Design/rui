...
| `color` | `RSurfaceColor` | no | Chooses the semantic container background color. |
| `contentColor` | `string` | no | Overrides the semantic foreground color inherited by surface content. |
