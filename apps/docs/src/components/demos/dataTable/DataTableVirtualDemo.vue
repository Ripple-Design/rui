...
<template>
    <div class="data-table-virtual-demo">
        <div class="data-table-virtual-demo__controls">
...
<style scoped>
.data-table-virtual-demo { display: grid; gap: 12px; }.data-table-virtual-demo__controls { display: flex; gap: 12px; align-items: center; }
</style>
