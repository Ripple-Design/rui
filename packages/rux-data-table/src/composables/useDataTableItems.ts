...
import type { RDataTableItem, RInternalDataTableColumn } from "../components/dataTable/types"
...
export function useDataTableItems<T>(props: { items?: readonly T[]; itemValue?: any; itemSelectable?: any; returnObject?: boolean }, columns: Ref<RInternalDataTableColumn<T>[]>): { items: ComputedRef<RDataTableItem<T>[]> } {
