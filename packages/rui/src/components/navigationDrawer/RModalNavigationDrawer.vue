...
import type { RModalNavigationDrawerProps } from "./types"
import { useNavigationDrawerDrag } from "./useNavigationDrawerDrag"
...
watch(() => props.selected, (value) => { selected.value = value })
