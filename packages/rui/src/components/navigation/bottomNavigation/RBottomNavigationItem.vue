...
import type { RBottomNavigationItemProps } from "./types.ts"

import RIcon from "../../base/icon/RIcon.vue"
import { bottomNavigationKey } from "./context.ts"
...
const classes = computed(() => [
    "rui-bottom-navigation-item",
    {
        ...
        "rui-bottom-navigation-item--shifting":
            navigation?.labelVisibility.value === "selected" && navigation.horizontalTranslation.value,
...
<template>
    ...
    >
        ...
        <span
            ...
            :class="{
                'rui-bottom-navigation-item__label--hidden':
                    navigation?.labelVisibility.value === 'unlabeled' ||
                    (navigation?.labelVisibility.value === 'selected' && !selected),
            }"
            aria-hidden="true"
        >
            <slot />
