...
.rui-switch {
 ...
 --rui-comp-switch-thumb-on-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-primary)100%);
 --rui-comp-switch-track-off-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-on-surface)32%);
 --rui-comp-switch-track-on-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-primary)54%);
 ...
 &--disabled {
 --rui-comp-switch-thumb-on-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-primary)38%);
 --rui-comp-switch-track-off-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-on-surface)12%);
 --rui-comp-switch-track-on-color: color-mix(in srgb, var(--rui-sys-color-surface), var(--rui-sys-color-primary)12%);
 cursor: default;
 }
}
...
.rui-switch__thumb {
 ...
 box-shadow: var(--rui-comp-switch-thumb-shadow);
