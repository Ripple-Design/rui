...
import type { RSnackbarDismissReason } from "./types.ts"

import RSnackbar from "./RSnackbar.vue"
import { useRSnackbarStore, type SnackbarSnapshot } from "./RSnackbars.ts"
...
.rui-snackbar-host {
    ...
    padding: 0 calc(8px + env(safe-area-inset-right, 0px)) calc(8px + env(safe-area-inset-bottom, 0px))
