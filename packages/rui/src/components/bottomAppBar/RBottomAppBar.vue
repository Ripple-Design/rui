...
import { scaffoldContextKey, type RScaffoldBottomAppBarFabState } from "@/components/scaffold/context"
import { useResizeObserver } from "@/utils/useResizeObserver"

import type { RBottomAppBarProps } from "./types"
...
const cradlePath = computed(() => createCradlePath(
...
<template>
    <footer ref="rootRef" class="rui-bottom-app-bar__host">
        ...
        >
            ...
            <div class="rui-bottom-app-bar__toolbar" role="toolbar" :aria-label="ariaLabel" :aria-labelledby="ariaLabelledby">
