...
@use "../../../foundations/touchTarget/touchTarget";
...
.rui-thumb__halo {
    ...
    transition:
        opacity var(--rui-comp-thumb-halo-duration, var(--rui-sys-motion-duration-small-in))
            var(--rui-comp-thumb-halo-easing, var(--rui-sys-motion-easing-standard)),
        transform var(--rui-comp-thumb-halo-duration, var(--rui-sys-motion-duration-small-in))
            var(--rui-comp-thumb-halo-easing, var(--rui-sys-motion-easing-standard));
